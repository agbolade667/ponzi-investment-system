...
echo "<script>alert('$current_row');


if($current_row = "")	
{
echo "<script>alert('You cannot be merged at this time. Please try again in 24 hours time.')</script>";
...
Email: $Email' 
	 ...
	 $sql_1 = mysql_query($query_1);
         ...
         if($user_leg1 == "")	
{        
	  $query_2 = "UPDATE gold SET Leg1 = 'true' WHERE Email = '$user_Email' ";
	  $sql_2 = mysql_query($query_2);
}

 else if($user_leg2 == "")	
{        
	  $query_2 = "UPDATE gold SET Leg2 = 'true' WHERE Email = '$user_Email' ";
	  $sql_2 = mysql_query($query_2);
}
